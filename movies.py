...
#movies = []
#with open("E:\\Assignment\\9)Association Rules\\my_movies.csv",sep=",")as f:movies = f.read()
movies=pd.read_csv("E:\\Assignment\\9)Association Rules\\my_movies.csv",sep=",")
...
data_dummies = pd.read_csv("E:\\Assignment\\9)Association Rules\\my_movies.csv")
